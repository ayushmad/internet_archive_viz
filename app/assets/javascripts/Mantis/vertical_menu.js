function VerticalMenu() {
    var VerticalMenu = new mantis.ViewBase("VerticalMenu", "actionlist");
    // Menus need to have a type associated with them
    VerticalMenu.type = "Menu";
    VerticalMenu.create_menu = function (object_hash) {
	...
	base_list.attr('class', 'verticalMenu')
		 .selectAll('li')
    ...
    VerticalMenu.message_handler[mantis.MessageType.SOURCE_UPDATE] = function (data) {
	this.create_menu(data);
    };

    VerticalMenu.message_handler[mantis.MessageType.VIEW_INIT] = function (data) {
